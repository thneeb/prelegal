...
import { GenericFormData, formatDate } from "../utils/templateUtils";
...
const mdComponents = {
  ...
  blockquote: ({ children }: { children?: React.ReactNode }) => (
    <blockquote className="border-l-4 border-gray-300 pl-4 italic text-gray-600 my-3">{children}</blockquote>
  ),
};
